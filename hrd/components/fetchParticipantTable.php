    ...
    if ($participantTableResult->num_rows > 0) {
      while ($participantTableData = $participantTableResult->fetch_assoc()) {
        ...
        if ($requiredDocs == 0) {
          ...
          <div class='update-status btn-group dropup' data-bs-toggle='modal' data-bs-target='#updateStatusModal'>
            <svg data-bs-toggle='dropdown' aria-expanded='false' data-bs-auto-close='outside' xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
