<nav style='width: 100%;'>
  ...
  <ol class='nav nav-sidebar'>
    <li class='nav-item'>
      <a href='../hrd/index.php?p=0' id="home">
    ...
    <li class='nav-item'>
      <a href='../hrd/index.php?p=1' id="addTraining">
    ...
    <li class='nav-item'>
      <a href='../hrd/index.php?p=2' id="notices">
        <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
    ...
    <li class='nav-item'>
      <a href='../hrd/index.php?p=3' id="messages">
    ...
    <li class='nav-item'>
      <a href='../hrd/index.php?p=4' id="generateID">
    ...
    <li class='nav-item'>
      <a href='../hrd/index.php?p=5' id="manageAccounts">
